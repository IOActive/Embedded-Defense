...
public class Dumper {
	...
	protected static String dump(Object o, DumpContext ctx) {
		...
		if (oClass.isArray() && !oClass.equals(char[].class)) {
			buffer.append("\n");
			...
			while (oClass != null && oClass != Object.class) {
				...
				if (ctx.ignoreList.get(oClass.getSimpleName()) == null) {
					...
					for (int i = 0; i < fields.length; i++) {
						...
						if (ctx.ignoreList.get(":" + fName) == null && ctx.ignoreList.get(fSimpleName + ":" + fName) == null
	...
	protected static String dumpValue(Object value, DumpContext ctx) {
		...
		if (value.getClass().isPrimitive() || value.getClass() == java.lang.Short.class || value.getClass() == java.lang.Long.class
			|| value.getClass() == java.lang.String.class || value.getClass() == java.lang.Integer.class || value.getClass() == java.lang.Float.class
			|| value.getClass() == java.lang.Byte.class || value.getClass() == java.lang.Character.class || value.getClass() == java.lang.Double.class
			|| value.getClass() == java.lang.Boolean.class || value.getClass() == java.util.Date.class || value.getClass().isEnum()) {
